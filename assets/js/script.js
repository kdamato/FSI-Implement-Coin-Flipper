...
let tailsPercent = document.querySelector('#tails');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    flipBtn.addEventListener{'click',function(){
        ...
        //This variable generates a number between 0 and 1
        // <= 0.5 is heads
        //Greater than 0.5 is tails
    ...
    // Flip Button Click Handler
        ...
        if(flipOutcome <=0.5){
            ...
            heads++;
            message.textContent = "Your Flipped Heads!"
        } else{
